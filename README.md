...
Extension of the original XKCD cli interface, some methods were extended (Ex. cd (change directory) allowing sublevels).
Man pages were set in a different script, allowing more text and information...
Ans still some work to do...
